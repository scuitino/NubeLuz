...
namespace AlmostEngine.Preview
{
		...
		public class ResolutionGalleryWindow : ResolutionWindowBase
		{
				...
				[MenuItem ("Window/Multi Device Preview and Gallery/Gallery")]
				...
				protected override void DrawToolBarGUI ()
				{
						...
						float zoom = EditorGUILayout.Slider (m_ConfigAsset.m_PreviewGalleryZoom, 0.05f, 2f);
				...
				Rect DrawResolutionPreview (Rect pos, ScreenshotResolution resolution)
				{
						...
						EditorGUI.DrawPreviewTexture (borderpos, m_BackgroundTexture);
						...
						height = (int)Mathf.Max (height, pos.y + size.y + m_ConfigAsset.m_GalleryTextHeight);
